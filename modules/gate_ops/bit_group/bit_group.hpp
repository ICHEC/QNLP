...
namespace QNLP{
    ...
    class BitGroup{
         ...
         * @param qaux_idx Indices of auxiliary qubits in qSim register that are set to |10>
         */
        static void bit_swap_s2e(SimulatorType& qSim, const std::vector<std::size_t>& qreg_idx, const std::vector<std::size_t>& qaux_idx){
            ...
            /**
             * @brief Apply the op from opposite ends of register working towards centre, reduce size from left, then repeat until 2 qubits remain.
             * 
             */
         ...
         * @param qaux_idx Indices of auxiliary qubits in qSim register that are set to |10>
         */
        static void bit_swap_pair(SimulatorType& qSim, const std::vector<std::size_t>& qreg_idx, const std::vector<std::size_t>& qaux_idx){
